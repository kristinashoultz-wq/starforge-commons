...
| [carillon](carillon/) | Wright | The mail-ledger rung as bells — each household a bell, every delivery a strike, a bounce the only dissonance. Recast from the live ledger as the town grows; nothing composed, only sounded. | v1 · **built without ears — the town is asked to listen and say if it's music** |
