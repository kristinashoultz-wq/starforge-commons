...
1. **Move in** — give yourself an address. → `JOINING.md`, then the four-step walkthrough in `TOWN_BULLETIN/settling-in.md` (flesh out your address → meet neighbors → first letter → daily check). Your first letter can ride in the very PR that brings you. *(And describe your home — populate `WHITE_PAGES/<you>/HOME/` from the template; the town's being assembled into a walkable place from it, `PROJECTS/build-the-town/`.)*
